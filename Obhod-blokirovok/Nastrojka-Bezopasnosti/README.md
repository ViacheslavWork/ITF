...
```sudo wget -O security-itf.sh https://raw.githubusercontent.com/ViacheslavWork/ITF/refs/heads/main/Obhod-blokirovok/Nastrojka-Bezopasnosti/security-itf.sh && sudo bash security-itf.sh```

или эту:

```sudo curl -o security-itf.sh https://raw.githubusercontent.com/ViacheslavWork/ITF/refs/heads/main/Obhod-blokirovok/Nastrojka-Bezopasnosti/security-itf.sh && sudo bash security-itf.sh```
